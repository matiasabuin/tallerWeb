...
insert into pelicula (poster, nombre) values ('pelicula1.jpg', 'American Psycho')
insert into pelicula (poster, nombre) values ('pelicula2.jpg', 'Nightcrawler')
insert into pelicula (poster, nombre) values ('pelicula3.jpg', 'Lord of the Rings')
insert into pelicula (poster, nombre) values ('pelicula4.jpg', 'Fight Club')