...
public class ControladorLoginTest {
	...
	ServicioHistorialUsuario servicioHistorial = mock(ServicioHistorialUsuario.class);

	
	ControladorLogin controladorLogin = new ControladorLogin(servicioLogin, servicioPlan, servicioUsuarioPlan, servicioNoticacion,servicioHistorial);
